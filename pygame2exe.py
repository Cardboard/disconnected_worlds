...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "disconnectedworlds"

        #Project url
        self.project_url = "http://www.ludumdare.com/compo/ludum-dare-30/?action=preview&uid=16294"
        ...
        #Auhor of program
        self.author_name = "Matthew Edwards"
        self.author_email = "ned3321@gmail.com"
        self.copyright = ""

        #Description
        self.project_description = "Ludum Dare Comp 30 - Disconnected Worlds"

        #Icon file (None will use pygame default icon)
        self.icon_file = "icon.ico"

        #Extra files/dirs copied to game
        self.extra_datas = ['assets', 'misc']
